"""NCU profiling script for OLD sparse_mla_sm120 decode kernel (V32, h=128, bs=1)."""
import torch
import sys
sys.path.insert(0, '.')
...
# Old API uses flat kv: [pool_size, 1, 656]
...
# Warmup
for _ in range(3):
    sparse_mla_sm120.sparse_mla_decode_fwd(q, kv_flat, indices, sm_scale, d_v)
torch.cuda.synchronize()

# Profiled iteration
sparse_mla_sm120.sparse_mla_decode_fwd(q, kv_flat, indices, sm_scale, d_v)
torch.cuda.synchronize()
print("Done (old kernel)")
